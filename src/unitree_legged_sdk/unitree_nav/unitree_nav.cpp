...
{
    udp.InitCmdData(cmd);
    sub_cmd_vel = nh.subscribe<geometry_msgs::Twist>("/cmd_vel", 1, &Custom::cmd_vel_callback, this);
    sub_test_string = nh.subscribe<std_msgs::String>("/test_string", 1, &Custom::test_string_callback, this);
}
