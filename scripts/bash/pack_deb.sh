...
# dpkg-deb -Zxz -z0 -b output/metacam_nav output/metacam_nav_1.3.8_arm64.deb
dpkg-deb -Zxz -z0 -b output/metacam_nav output/metacam_nav_jinzhong_1.4.9_arm64.deb
